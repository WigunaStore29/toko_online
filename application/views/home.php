      ...
      <div class="owl-banner owl-carousel">
        <div class="banner-item-01">
          <div class="text-content">
            <h4>INI dsdsddsdsds</h4>
            <h2>Strategi Pemain Game dsadsadsa</h2>
          </div>
        </div>
    ...
    <div class="best-features">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>About <b>ubdah baru <span class="store_home">STORE</span></b> </h2>
            </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="right-image">
              <img src="assets/images/ubah.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
