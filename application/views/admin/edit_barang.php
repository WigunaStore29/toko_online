                ...
                <form action="<?= base_url() . 'admin/Data_barang/update'; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="custom-select custom-select-lg mb-3 form-control" name="kategori">
                            ...
                            <option value="Keyboard" <?= $kategori == "Keyboard" ? "selected" : "" ?>>Keyboard</option>
                            <option value="Kursi" <?= $kategori == "Kursi" ? "selected" : "" ?>>Kursi</option>
                            <option value="Mouse" <?= $kategori == "Mouse" ? "selected" : "" ?>>Mouse</option>
                            <option value="Mousepad" <?= $kategori == "Mousepad" ? "selected" : "" ?>>Mousepad</option>
                            <option value="Headset" <?= $kategori == "Headset" ? "selected" : "" ?>>Headset</option>
                        </select>
                    </div>
                    <!-- KATEGORI 2 -->
                    <div class="mb-3">
